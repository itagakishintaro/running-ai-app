...
// 陸路・橋・トンネルで行き来しやすい隣接都道府県（日帰り〜前泊圏の近似）
...
// 自県＋隣接県のリストを返す
export function nearbyPrefectures(prefecture: string): string[] {
  return [prefecture, ...(ADJACENCY[prefecture] ?? [])];
}
